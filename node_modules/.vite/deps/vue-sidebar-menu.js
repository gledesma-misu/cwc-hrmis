...
var initSidebar = function initSidebar2(props, context) {
  ...
  var updateActiveShow = function updateActiveShow2(id) {
    activeShow.value = id;
  };
...
function useItem(props) {
  ...
  var _useSidebar = useSidebar(), sidebarProps = _useSidebar.getSidebarProps, isCollapsed = _useSidebar.getIsCollapsed, activeShow = _useSidebar.getActiveShow, mobileItem = _useSidebar.getMobileItem, mobileItemRect = _useSidebar.getMobileItemRect, currentRoute = _useSidebar.getCurrentRoute, updateActiveShow = _useSidebar.updateActiveShow, setMobileItem = _useSidebar.setMobileItem, unsetMobileItem = _useSidebar.unsetMobileItem, clearMobileItemTimeout = _useSidebar.clearMobileItemTimeout, emitItemClick = _useSidebar.emitItemClick;
  ...
  var isChildActive = function isChildActive2(child) {
    if (!child)
      return false;
    return child.some(function(item) {
      return isLinkActive(item) || isChildActive2(item.child);
    });
  };
...
var _hoisted_1$3 = ["href", "onClick"];
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_router_link = resolveComponent("router-link");
  return $options.isHyperLink ? (openBlock(), createElementBlock(
    "a",
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return typeof $props.icon === "object" && $props.icon.text ? (openBlock(), createBlock(
    resolveDynamicComponent($props.icon.element ? $props.icon.element : "i"),
    normalizeProps(mergeProps({ key: 0 }, $options.attributes)),
    {
      default: withCtx(() => [
        createTextVNode(
          toDisplayString($props.icon.text),
          1
          /* TEXT */
        )
      ]),
    ...
    16
    /* FULL_PROPS */
  )) : typeof $props.icon === "object" ? (openBlock(), createBlock(
    resolveDynamicComponent($props.icon.element ? $props.icon.element : "i"),
    normalizeProps(mergeProps({ key: 1 }, $options.attributes)),
    null,
    16
    /* FULL_PROPS */
  )) : (openBlock(), createElementBlock(
    "i",
    normalizeProps(mergeProps({ key: 2 }, $options.attributes)),
    null,
    16
    /* FULL_PROPS */
  ));
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.badge.text ? (openBlock(), createBlock(
    resolveDynamicComponent($props.badge.element ? $props.badge.element : "span"),
    normalizeProps(mergeProps({ key: 0 }, $options.attributes)),
    {
      default: withCtx(() => [
        createTextVNode(
          toDisplayString($props.badge.text),
          1
          /* TEXT */
        )
      ]),
...
var _hoisted_2$2 = { class: "vsm--dropdown" };
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $props.item.component && !$setup.isHidden ? (openBlock(), createElementBlock("li", _hoisted_1$2, [
    (openBlock(), createBlock(
      resolveDynamicComponent($props.item.component),
      normalizeProps(guardReactiveProps($props.item.props)),
      null,
      16
      /* FULL_PROPS */
    ))
  ])) : $props.item.header && !$setup.isHidden ? (openBlock(), createElementBlock(
    "li",
    mergeProps({
      key: 1,
      class: ["vsm--header", $props.item.class]
    }, $props.item.attributes),
    toDisplayString($props.item.header),
    17
    /* TEXT, FULL_PROPS */
  )) : !$setup.isHidden ? (openBlock(), createElementBlock(
    "li",
    mergeProps({
      key: 2,
      ...
      $setup.isCollapsed && $setup.isFirstLevel ? { mouseenter: $setup.onMouseEnter, mouseleave: $setup.onMouseLeave } : {},
      true
    )),
    [
        ...
        default: withCtx(() => [
          ...
          createBaseVNode(
            ...
            [
              ...
              $setup.hasChild ? (openBlock(), createElementBlock(
                "div",
                {
                  key: 1,
      ...
      $setup.hasChild ? (openBlock(), createBlock(Transition, {
        key: 0,
            ...
            [
              createBaseVNode("ul", _hoisted_2$2, [
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
                  renderList($props.item.child, (subItem) => {
...
var _hoisted_1$1 = { class: "vsm--scroll-wrapper" };
var _hoisted_2$1 = { class: "vsm--scroll-overflow" };
...
var _hoisted_1 = createBaseVNode(
  "span",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [
          ...
          createBaseVNode(
            ...
            [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList($setup.computedMenu, (item) => {
                  return openBlock(), createBlock(_component_sidebar_menu_item, {
                    key: item.id,
                    item
                  }, {
      ...
      !$props.hideToggle ? (openBlock(), createElementBlock("button", {
        key: 0,
